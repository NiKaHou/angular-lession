export class GlobalConstants {
  ...
  public static readonly routeStateKey = 'laas_routeState';
  public static readonly languageKey = 'laas_language';
  public static readonly defaultLanguage = 'zh-tw';
  public static readonly cacheKey = 'laas_cache';
  public static readonly currentUser = 'laas_user';
  public static readonly currentToken = 'lass_token';
  public static readonly userPreference = 'laas_user_preference';
  public static readonly menuIconMap = new Map<string, string>([
